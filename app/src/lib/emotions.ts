...
export const EMOTIONS: Emotion[] = [
  ...
  { word: "Impatient", x: -4, y: 4, definition: "Waiting on something, and done with waiting." },
  { word: "Resentful", x: -6, y: 3, definition: "Anger that went quiet and stayed." },
  { word: "Disgusted", x: -5, y: 3, definition: "Repelled by something — you want it away from you." },
  { word: "Unsettled", x: -4, y: 3, definition: "Something is off and you can't name it yet." },
  ...
  { word: "Awed", x: 7, y: 4, definition: "Faced with something big enough to rearrange you." },
  { word: "Curious", x: 5, y: 3, definition: "Pulled toward something you don't understand yet." },
  { word: "Absorbed", x: 6, y: 3, definition: "So far into it that time stopped reporting in." },
  { word: "Affectionate", x: 7, y: 3, definition: "Warm towards someone, and close to them." },

  // Low energy, unpleasant
  { word: "Ashamed", x: -6, y: -2, definition: "The feeling that the problem is you, not the thing you did." },
  { word: "Hurt", x: -5, y: -2, definition: "Someone you trusted did something, and it landed." },
  { word: "Insecure", x: -5, y: -2, definition: "Unsure you measure up to what's being asked." },
  { word: "Grieving", x: -6, y: -3, definition: "Carrying a loss that won't shrink to fit the day." },
  ...
  // Low energy, pleasant
  { word: "Steady", x: 5, y: -2, definition: "Nothing dramatic. You're holding, and that's enough." },
  ...
  { word: "Fine", x: 5, y: -3, definition: "Nothing's wrong — and that's all you can say about it." },
  { word: "Accepting", x: 6, y: -3, definition: "Not fighting the shape of it any more." },
